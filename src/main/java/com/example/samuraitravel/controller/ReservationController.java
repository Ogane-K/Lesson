...
public class ReservationController {
    ...
    public String input(@PathVariable(name = "id")Integer id,
                        ...
                        Model model) 
                        {
                            ...
                            if (numberOfPeople != null && !reservationService.isWithCapacity(numberOfPeople, capacity)) {
                            ...
                            ReservationDTO reservationDTO = new ReservationDTO(id, checkinDate, checkoutDate, numberOfPeople, amount);
    ...
    public String confirm(RedirectAttributes redirectAttributes, HttpSession httpSession, Model model) {
        ...
        if (reservationDTO == null) {
            redirectAttributes.addFlashAttribute("セッションがタイムアウトしました。もう一度予約内容を入力したください。");
    ...
    public String postMethodName(@AuthenticationPrincipal UserDetailsImpl userDetailsImpl,RedirectAttributes redirectAttributes,HttpSession httpSession) {
