...
public class AdminHouseControllerTest {
	...
	public void 未ログインの場合は民宿を更新せずにログインページにリダイレクトする() throws Exception {
		...
		Optional<House> optionalHouse = houseService.findHousesById(1);
	...
	@WithUserDetails("taro.samurai@example.com")
	@Transactional
	public void 一般ユーザーとしてログイン済みの場合には民宿を更新せずに403エラーが発生する() throws Exception {
	...
	@Transactional
	@WithUserDetails("hanako.samurai@example.com")
	public void 管理者ユーザーとしてログイン済みの場合は民宿削除後に民宿一覧ページに正常にリダイレクトする() throws Exception {
